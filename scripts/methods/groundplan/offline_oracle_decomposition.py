...
from scripts.methods.groundplan.grounding.code import execute_grounding_code
...
from scripts.methods.groundplan.planner.debug_annotation_planner import _grounded_program_from_annotations
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Offline GroundPlan Direct-CaP oracle decomposition; no LLM calls.")
