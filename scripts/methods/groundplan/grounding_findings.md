# GroundPlan Grounding Findings

This note summarizes the current findings from comparing two GroundPlan
grounding designs:
...
python scripts/methods/groundplan/run.py \
  --set valunseen \
  --limit 50 \
  --output-root resources/methods/groundplan/previous/GroundPlan_api_program \
  --llm-cache-root resources/methods/groundplan/previous/GroundPlan_api_program/_llm_cache \
  --overwrite \
