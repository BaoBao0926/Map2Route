...
from scripts.methods.groundplan.grounding.code import GroundingRuntime
from scripts.methods.groundplan.grounding.semantic_api import (
    SEMANTIC_API_NAMES,
    gemini_function_declarations,
)
from scripts.methods.groundplan.grounding.tool_call import ToolCallGrounder, _ToolSession
from scripts.methods.groundplan.test_grounding_representations import _Scene
from scripts.methods.groundplan.pipeline import GroundPlanRunConfig, resolve_grounding_architecture
from scripts.methods.groundplan.run import REPRESENTATION_VARIANTS
...
class ToolCallGrounderTests(unittest.TestCase):
    ...
    def test_cli_aliases_resolve_to_tool_architecture(self) -> None:
        ...
        architecture = resolve_grounding_architecture(GroundPlanRunConfig(grounding_variant="tool_call"))
        ...
        no_repair = resolve_grounding_architecture(GroundPlanRunConfig(grounding_variant="tool_call", execution_repair="off"))
