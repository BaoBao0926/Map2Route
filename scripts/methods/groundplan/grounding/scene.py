"""SceneMap construction and restricted map queries for GroundPlan."""
...
from scripts.methods.groundplan.ir import Cell, GPRef
...
class SceneMap:
    """Restricted semantic-map view used by GroundPlan's deterministic grounder."""
