"""Gemini native function-calling transport for GroundPlan ToolCall."""
...
from scripts.methods.groundplan.llm_client import (
...
def tool_turn(
    ...
    *,
    ...
    if not api_key:
        raise RuntimeError("Gemini API key is required for GroundPlan ToolCall mode.")
