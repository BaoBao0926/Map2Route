"""Native function-calling grounder over the existing GroundPlan runtime."""
...
from scripts.methods.groundplan.grounding.code import GroundingRuntime, verify_grounded_program
from scripts.methods.groundplan.grounding.grounder import GroundingFailure
from scripts.methods.groundplan.grounding.scene import SceneMap
from scripts.methods.groundplan.grounding.tool_client import tool_turn
from scripts.methods.groundplan.grounding.semantic_api import (
    PREDICATE_NAMES,
    SEMANTIC_API_NAMES,
    gemini_function_declarations,
)
from scripts.methods.groundplan.ir import GPRef, GroundedProgram
...
Convert the free-form route instruction into GroundPlan's existing RouteIR by
        ...
        while llm_turns < self.max_llm_turns:
            ...
            try:
                content, call_meta = tool_turn(
                    ...
                    cache_namespace=f"groundplan_tool_call_turn_{llm_turns}",
                )
            except Exception as exc:
