...
from scripts.methods.groundplan.parse.scene_catalog import (
    catalog_reference,
...
def llm_parse_direct_id_instruction(
    ...
    *,
    ...
    text, meta = llm_client.response_text(
        ...
        user_prompt=prompt,
        cache_namespace="groundplan_direct_id_catalog_v1",
    )
    ...
    try:
        ...
        repaired, repair_meta = llm_client.response_text(
            ...
            cache_namespace="groundplan_direct_id_catalog_parse_repair_v1",
        )
        try:
...
def direct_id_to_program(
    ...
    *,
    ...
    """Validate final IDs and compile them to the shared GroundPlan IR."""
