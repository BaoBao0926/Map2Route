...
from scripts.methods.grounding2route.grounding.code import execute_grounding_code, verify_grounded_program
from scripts.methods.grounding2route.ir import GPRef, GroundedConstraint, GroundedProgram, GroundedSegment, PlannedSegment
from scripts.methods.grounding2route.planner.semantic_astar import active_constraints_for_segment, plan_grounded_program
...
"""
    ...
    def test_segment_scope_controls_planner_activation_not_host_container(self) -> None:
        ...
        for _name, (scope, expected) in cases.items():
            ...
            with patch(
                "scripts.methods.grounding2route.planner.semantic_astar.plan_segment",
