"""Gemini REST helper for Grounding2Route parsing."""
...
from scripts.methods.grounding2route.config import DEFAULT_MODEL
...
class GeminiClient:
    ...
    def response_text(
        ...
        *,
        ...
        if not api_key:
            raise RuntimeError("Gemini API key is required for Grounding2Route LLM parser mode.")
