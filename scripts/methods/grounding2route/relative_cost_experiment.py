#!/usr/bin/env python3
"""Compare Grounding2Route relative-cost formulations with oracle annotations.
...
from scripts.methods.grounding2route.config import MAX_EXPANSIONS
...
from scripts.methods.grounding2route.planner.debug_annotation_planner import (
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Zero-LLM oracle sweep for Grounding2Route relative cost."
    )
