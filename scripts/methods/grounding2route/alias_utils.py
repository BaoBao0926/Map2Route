"""Helpers for learned Grounding2Route category aliases."""
...
from scripts.methods.grounding2route import alias
...
def _write_alias_file(
    ...
    text = (
        '"""Learned Grounding2Route category aliases.\n\n'
        "This file is updated by the Grounding2Route alias resolver when Gemini maps an\n"
